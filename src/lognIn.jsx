                        ...
                        <div className="registration_box">
                            <div className="w-100 pt-3 px-3">
                                <div className="reg_header d-flex justify-content-between pb-2">
                                    <h1 className="h1_createAcc">Sign In</h1>

                                    <div className="d-flex align-items-center justify-content-end">
                                        <span className="span_gray_account">New here? </span>

                                        <Link to={ "/registration" } className="SignIn_gray gray_create_acc text-decoration-none d-flex justify-content-center align-items-center">Create Account</Link>
                                    </div>
                                </div> 
                                ...
                                <form id="myForm" action="submit_form.php" method="POST" onSubmit={(event) => login(event)}> {/* FORM */}
                                    <div className="w-100 pt-3">
                                        <div className="w-100 d-flex justify-content-between">
                                            <label className="form_label pb-1">Username or Email</label>

                                            <button className="remind_me_button" type="button">Remind me</button>
                                        </div>
                                    ...
                                    <div className="w-100">
                                        <div className="w-100 d-flex justify-content-between">
                                            <label className="form_label pb-1">Password</label>

                                            <button className="remind_me_button" type="button">Forgot</button>
                                        </div>
                                        <input type="password" className="form_input w-100 mb-1" onChange={(event) => setPassword(event.target.value)} />
                                    </div>
                            ...
                            <div className="w-100 mt-4 background_darker_white py-4 px-3 d-flex justify-content-end">
                                <input form="myForm" className="create_acc_button sign_in_btn" value="Sign in & continue" type="submit" />
                            </div>
                        </div>
